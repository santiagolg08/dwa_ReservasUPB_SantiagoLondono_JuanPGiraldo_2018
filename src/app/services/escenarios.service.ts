...
export class EscenariosService {
  ...
  public lista_src_escenarios = [
    [
      ...
      "../../assets/img/fotos_escenarios/escenario_fundadores_5.JPG",
      "../../assets/img/fotos_escenarios/escenario_fundadores_7.JPG",
    ],
    [
    ...
    [
      ...
      "../../assets/img/fotos_escenarios/escenario_polideportivo_7.jpg",
      "../../assets/img/fotos_escenarios/escenario_polideportivo_6.JPG",
    ],
    [
    ...
    [
      ...
      "../../assets/img/fotos_escenarios/escenario_placas_7.JPG",
